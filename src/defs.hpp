...
// problem generator
#define PROBLEM_GENERATOR "inner_disk"
...
#define COMPILED_WITH_OPTIONS " -I/opt/homebrew/opt/hdf5-mpi/include -O3 -std=c++11  -L/opt/homebrew/opt/hdf5-mpi/lib  -lhdf5" // NOLINT
...
#define NRAD 440  // Radiation variables for history output
